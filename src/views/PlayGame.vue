...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.dicePan= {x: this.box_width / 2 - 70, y: 76, width: 140, height: 90},
            this.getMyIp();
            ...
            setInterval(() => {
                ...
                switch (timePoint) {
                    ...
                    case 34000:
                        ...
                        this.timer = null;
                        this.thrownCredits = [];
                        this.moveStopBetting(this.box_width / 2 - 225, 152, 450, 395, 200);
                        setTimeout(() => {
                    ...
                    case 36000:
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    this.moveResultBoardDiceOne(this.box_width / 2 - 350, 345, 100, 200);
                                    setTimeout(() => {
                ...
                this.realBets = this.realBets.filter((bet) => {
                    return (
                        bet.startPos.x + bet.time * bet.speed.x !== this.box_width - 100 &&
        ...
        methods: {
                ...
                if (this.status) {
                    ...
                    this.betPostions.map((position) => {
                        if (
                            ...
                            e.offsetX < position.x + (this.box_width - 760) / 2 - 237 + position.w &&
            ...
            drawBoard(ctx) {
                ...
                this.drawOval(ctx, this.box_width / 2 - 98.5, 92, 195, 95, "#1D202D", null);
                this.drawOval(ctx, this.box_width / 2 - 98.5, 76, 195, 95, "#282B3D", null);
